...
export default function Home() {
    //Declear state Variable in React
    ...
    return (
        <>
            <Navbar />
            <section className="bg-[url(./assets/images/image.png)] h-[596px] bg-cover w-[95%] mx-auto relative">
            ...
            <section className="mt-20">
                <div>
                    <h1>
                        <span className="uppercase text-2xl text-bolder mb-2">Upcoming</span>
